# Flood Dynamics and Risk Assessment
 ...
 This repository provides a [web application](https://kietpawpan.github.io/flood/flood.html) for assessing risk associated with flood dynamics in Bangkok, which might be a useful tool to the local government for disater (water) risk management.
